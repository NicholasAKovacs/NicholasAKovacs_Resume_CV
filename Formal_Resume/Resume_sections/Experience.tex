  ...
  \cventry
    ...
    {{\textbf{Dissertation}: \textit{Data Mining the Atomic Structure of the Ribosome to Unravel the History of Protein Folding}}
      ...
      \vspace{4.0mm}
        ...
        \item \textbf{Collaboration}: Coauthored 2 experimental and 3 computational research articles. 3\textsuperscript{rd} computational coauthored research article under review.
