...
%---------------------------------------------------------
  \cventry
    ...
    {{\textbf{Dissertation}: \textit{Data Mining the Atomic Structure of the Ribosome to Unravel the History of Protein Folding}}
      ...
      \vspace{4.0mm}
        ...
        \item \textbf{Results}: 1\textsuperscript{st} first-author research article published, 2\textsuperscript{nd} is submitted, and 3\textsuperscript{rd} in preparation.
        \item \textbf{Collaboration}: Coauthored 2 experimental and 3 computational research articles. 3\textsuperscript{rd} computational research article under review.
 ...
 %---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
      	\item Collaborated with a team member to apply course concepts and algorithms to 3 interaction networks of the ribosome, each composed of more than 100,000 non-covalent interactions (edges) between approx. 50,000 atoms (nodes). 
 ...
 %---------------------------------------------------------
  \cventry
    {Course Project for BIOL 7210 - Computational Genomics} % Job title
