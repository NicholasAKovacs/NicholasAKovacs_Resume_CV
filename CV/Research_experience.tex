  ...
  \cventry
    ...
    {{\textbf{PhD Thesis}: \textit{The History of Proteins Revealed by Data Mining the Ribosome}}
      ...
      \vspace{4.0mm}
        ...
        \item {\textbf{Tools}: Python {/smal (Numpy, Pandas, SciPy, Jupyter, SK-Learn, Matplotlib, NetworkX, TensorFlow)}l, PyMOL, Adobe Illustrator, Perl, MATLAB, JavaScript}
...
%---------------------------------------------------------
  \cventry
    {Undergraduate Research Associate} % Job title
    {Adviser: Dr. Yai Shachar-Hill} % Organization
    {Michigan State University} % Location
