...
\lettertitle{Application for Bioinformatics Fellowship, position number CDC-NCHHSTP-2019-0016}
% How the letter is opened
\letteropening{Dear Dr. Kim Gernet (CDC/DDID/NCHHSTP),}
...
\lettersection{Why the Bioinformatics Fellowship with the NCHHSTP at the CDC?}
