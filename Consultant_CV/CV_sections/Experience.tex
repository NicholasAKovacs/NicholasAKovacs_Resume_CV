  ...
  \cventry
    ...
    {{\textbf{Dissertation}: \textit{Data Mining the Atomic Structure of the Ribosome to Unravel the History of Protein Folding}}
      ...
      \vspace{4.0mm}
        ...
        \item \textbf{Results}: Two 1\textsuperscript{st}-author research articles published. 3\textsuperscript{rd} in preparation. 143 total citations.
        \item \textbf{Funding}: NASA Astrobiology Institute
        \item \textbf{Collaboration}: Provided computational analysis for coworkers' projects; coauthor of 2 experimental and 4 computational research articles.
