...
%    {
%      \begin{cvitems} % Description(s) of tasks/responsibilities
%      	\item Collaborated with a team member to apply course concepts and algorithms to PhD %project data consisting of 3 atomic interaction networks of the biomolecule, the ribosome, each %composed of more than 100,000 edges between approx. 50,000 nodes. 
